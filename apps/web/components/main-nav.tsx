...
function NavButton({ href, label, variant = "solid", children }: { href: string; label: string; variant?: "solid" | "outline"; children: React.ReactNode }) {
  const outlineStyle: React.CSSProperties = {
    ...btnBase,
    color: "#F5C800",
    backgroundColor: "transparent",
    border: "2px solid #F5C800",
    boxShadow: "3px 3px 0 #F5C800",
  }
  return (
    <a
      href={href}
      ...
      onMouseEnter={(e) => {
        ...
        if (variant === "outline") {
          el.style.backgroundColor = "rgba(245,200,0,0.1)"
          el.style.boxShadow = "1px 1px 0 #F5C800"
        } else {
      ...
      onMouseLeave={(e) => {
        ...
        if (variant === "outline") {
          ...
          el.style.boxShadow = "3px 3px 0 #F5C800"
        } else {
