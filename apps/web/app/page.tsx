    ...
    <>
      ...
      <main className="min-h-screen flex flex-col">
        ...
        <section className="flex-1 flex flex-col items-center justify-center pt-[220px] px-10 pb-[100px] text-center gap-8 sm:pt-[180px] sm:px-5 sm:pb-[60px] xs:px-3.5">
          ...
          {/* Headline */}
          <h1
            className="font-[family-name:var(--font-pixel)] text-[#FAFAF5] leading-[1.6] m-0 max-w-[900px] flex flex-col items-center gap-4"
            style={{ fontSize: "clamp(0.875rem, 2.5vw, 1.625rem)" }}
          >
            <span>Claim your</span>
            <span
              className="text-[#0D0D0D] bg-[#F5C800] px-8 py-3 tracking-[0.05em] inline-block"
              style={{
          ...
          {/* Subheadline */}
          <p className="font-[family-name:var(--font-sans)] text-[15px] text-[#888888] leading-[1.7] m-0 max-w-[480px]">
