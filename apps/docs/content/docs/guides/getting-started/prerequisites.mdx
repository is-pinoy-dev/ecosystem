...
You'll need the CNAME record value from your hosting provider before you create your JSON file. On **Vercel** you also need a `vc-domain-verify` TXT value — it is always required, not optional.

See the [Provider Guides](/guides/providers) section for step-by-step instructions on finding these values.
...
Once you have everything above, continue to [Naming Rules](/guides/getting-started/naming-rules).
