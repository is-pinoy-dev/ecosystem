...
If you see output like this, your file is valid. Move on to [Open a PR](/guides/workflow/open-pr).
...
<Callout type="info">
  For a full list of validation errors and how to fix them, see [Common Errors](/guides/troubleshooting/common-errors).
</Callout>
