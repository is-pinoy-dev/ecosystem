...
<Steps>
  ...
  <Step>
    ...
    Now that you have your DNS values, go to [Create Your JSON File](/workflow/create-file) to add them to your file.
...
Once your JSON file is ready, proceed to [Validate](/workflow/validate).
